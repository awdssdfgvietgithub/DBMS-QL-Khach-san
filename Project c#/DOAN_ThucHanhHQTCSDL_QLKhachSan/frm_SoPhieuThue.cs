...
{
    public partial class frm_SoPhieuThue : Form
    {
        SqlConnection conn = new SqlConnection();
        public frm_SoPhieuThue()
        {
            InitializeComponent();
        ...
        public void load_database_gridview()
        {
            ...
            SqlCommand c3 = new SqlCommand("exec InSoPhieuThue_KH N'" + ten + "'", conn);
        ...
        private void frm_SoPhieuThue_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Tim_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand c4 = new SqlCommand("exec InPhieuThue_KH N'" + ten + "'", conn);
